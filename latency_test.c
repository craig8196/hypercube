...
main(int argc, char *argv[])
{
    ...
    int num_procs_involved = {3, 6, 9, 15};
    int proc_to_broadcast_from = {5, 5, 5, 5};
    int proc_to_reduce_to = {5, 5, 5, 5};
    int number_of_iterations = 5;
    int sizes_of_data = {1, 512, 4096, 32768, 65536}
    ...
    if(iproc == 0)
    {
        for(i = 0; i < sizes_of_data[0]; i++)
        {
            printf("%d: reduced[%d] = %lf", iproc, i, receive_buffer[0]);
        }
    }
